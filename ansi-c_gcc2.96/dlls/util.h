...
#define VEC_HUMAN_HULL_MAX	Vector( 16, 16, 64 )          // 72
#define VEC_HUMAN_HULL_DUCK	Vector( 16, 16, 32 )       // 36
...
inline void GW_EMIT_SOUND(edict_t *entity, int channel, const char *sample, float volume, float attenuation, float pitch)
{
...
#define PLAYBACK_EVENT1( flags, who, index, x1) PLAYBACK_EVENT_FULL( flags, who, index, 0, (float *)&g_vecZero, (float *)&g_vecZero, 0.0, 0.0, x1, 0, 0, 0);
#define PLAYBACK_EVENT2( flags, who, index, x1, x2) PLAYBACK_EVENT_FULL( flags, who, index, 0, (float *)&g_vecZero, (float *)&g_vecZero, 0.0, 0.0, x1, x2, 0, 0);
#define PLAYBACK_EVENT3( flags, who, index, x1, x2, x3) PLAYBACK_EVENT_FULL( flags, who, index, 0, (float *)&g_vecZero, (float *)&g_vecZero, 0.0, 0.0, x1, x2, x3, 0);
#define PLAYBACK_EVENT4( flags, who, index, x1, x2, x3, x4) PLAYBACK_EVENT_FULL( flags, who, index, 0, (float *)&g_vecZero, (float *)&g_vecZero, 0.0, 0.0, x1, x2, x3, x4);
