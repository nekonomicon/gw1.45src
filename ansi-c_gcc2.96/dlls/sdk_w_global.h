...
inline int FireSharpBullet(CBasePlayer *m_pPlayer, entvars_t *pev, const int weapon_enum)
{
   TraceResult tr;  
   int retraced = 0;
...
inline int FireFlatBullet(CBasePlayer *m_pPlayer, entvars_t *pev, const int weapon_enum)
{
   TraceResult tr;
   int retraced = 0;
...
inline int FireStrongBullet(CBasePlayer *m_pPlayer, entvars_t *pev, const int weapon_enum, int m_fInZoom)
{
   TraceResult tr;      
   Vector anglesAim, vecDir, vecSrc, vecEnd, vecEnd2;  
   int retraced = 0;
