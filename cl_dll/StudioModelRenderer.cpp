...
void CStudioModelRenderer::StudioProcessGait( entity_state_t *pplayer )
{
	...
	// adjust torso
   /*
   m_pCurrentEntity->curstate.controller[0] = 30 + rand() & 60;
   m_pCurrentEntity->curstate.controller[1] = 0;
   m_pCurrentEntity->curstate.controller[2] = 0;
   m_pCurrentEntity->curstate.controller[3] = 0;
   m_pCurrentEntity->curstate.controller[0] = -30 + rand() & 60;
   m_pCurrentEntity->curstate.controller[1] = -30 + rand() & 60;
   m_pCurrentEntity->curstate.controller[2] = -30 + rand() & 60;
   m_pCurrentEntity->curstate.controller[3] = -30 + rand() & 60;
   */
   /*
   */
